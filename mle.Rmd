...
counts_MLE = function(alpha, counts, q=6, bvm=13){
  ...
  pinit = c(tildecounts=rnorm(1, 10.25, .2), Sa=rlnorm(1, log(1/300), .1), sz=rnorm(1, 0.25, .1), aa=rnorm(1, 3, .2), bb=rnorm(1, 0.4, .05)) 
  ...
  c(F_b(par[1], 13), F_Sa(par[2]), abs(par[3]), abs(par[4]), abs(par[5]), mle)}
```
