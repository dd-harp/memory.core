...
devtools::load_all("../ramp.falciparum")
```
...
```{r}
counts_MLE(alpha_list, counts_list, inits=pinit(), 5,  F_b, F_Sa) -> fits1
```

```{r, eval=F}
counts_MLE(alpha_list, counts_list, pinit(), 5,   F_b, F_Sa) -> fits1
counts_MLE(alpha_list, counts_list, pinit(), 2,   F_b, F_Sa) -> fits2
counts_MLE(alpha_list, counts_list, pinit(), 1,   F_b, F_Sa) -> fits3
counts_MLE(alpha_list, counts_list, pinit(), 0.5, F_b, F_Sa) -> fits4
counts_MLE(alpha_list, counts_list, pinit(), 0.2, F_b, F_Sa) -> fits5
```
